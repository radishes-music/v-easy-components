  ...
  export default {
    ...
    methods: {
      ...
      handleMouseMove(e) {
        ...
        const parentOffset = (this.$el.offsetParent.getBoundingClientRect()[direction] - e[client]) * -1
        const thumbClickPosition = this.$el[offset] - this[axis]
        const thumbPositionPercentage = ((parentOffset - thumbClickPosition) * 100 / this.$el.offsetParent[offset]);
