...
module.exports = {
  ...
  head: [
    ...
    ['link', { rel: 'apple-touch-icon', href: '/rec_static_/logo/logo@152.png' }],
    ['link', { rel: 'mask-icon', href: '/icons/safari-pinned-tab.svg', color: '#3eaf7c' }],
    ['meta', { name: 'msapplication-TileImage', content: '/rec_static_/logo/logo@144.png' }],
  ...
  ],'@vuepress/search', '@vuepress/back-to-top', '@vuepress/pwa'],
  themeConfig: {
